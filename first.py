...
data = data.reshape(1,145,145,220)
#%%
...
hist = model.fit(data_norm, data_norm, epochs = 10)
...
#%%
import os
tifffile.imsave("data_encc.tiff", data_enc)
stats_enc = os.stat("data_encc.tiff")
stats_data = os.stat("Indian_pines.mat")    
